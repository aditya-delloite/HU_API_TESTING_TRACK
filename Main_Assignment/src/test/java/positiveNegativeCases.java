...
public class positiveNegativeCases {
    ...
    @Test(priority = 6)
    public  void login_with_unregistered_Details() throws IOException {

        String Path_Of_Excel_File = "C:\\Users\\adityakumar3\\Desktop\\DataBase_Api\\unregisteredDatabase.xlsx";
        String SHEET_NAME_INSIDE_THE_EXCEL = "unregistered";

       log.info("Logging in with the wrong id and password");

        String email = javaUtility.getCellvalue(Path_Of_Excel_File, SHEET_NAME_INSIDE_THE_EXCEL, 1, 0);
        String password = javaUtility.getCellvalue(Path_Of_Excel_File, SHEET_NAME_INSIDE_THE_EXCEL, 1, 1);
